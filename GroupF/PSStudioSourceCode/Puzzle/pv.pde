...
class pt { float x=0,y=0; 
  ...
  pt moveWithMouseX() {x += mouseX-pmouseX;  return this;};  
  pt moveWithMouseY() {y += mouseY-pmouseY;  return this;};  
  // DRAW , WRITE
...
void morph(pt A0, pt B0, pt C0, pt A1, pt B1, pt C1, float t, pt At, pt Bt, pt Ct) {
  ...
  Ct.setTo(P(At,xt,V(At,Bt),yt,R(V(At,Bt))));
  }
